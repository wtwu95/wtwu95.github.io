...
<div class="publication-more">
  <a class="publication-more__link" href="{{ '/publication-list/' | relative_url }}">See More Publications →</a>
</div>
...
<style>
  ...
  .publication-more__link {
    display: inline-flex;
    align-items: center;
    gap: 0.35rem;
    padding: 0.55rem 1.25rem;
    border-radius: 999px;
    background: var(--publication-accent, #0052cc);
    color: #fff !important;
  ...
  .publication-more__link:hover,
  .publication-more__link:focus-visible {
    background: var(--publication-accent-hover, #0747a6);
    transform: translateY(-1px);
  }

  .publication-more__link:focus-visible {
    outline: none;
    box-shadow: 0 0 0 3px var(--publication-accent-soft, rgba(0, 82, 204, 0.2));
  }
</style>
