...
<p class="publication-preview-more"><a href="{{ '/publications/' | relative_url }}">View the complete publication list →</a></p>

<style>
.publication-preview-more {
  margin-top: 1.5rem;
  text-align: right;
}

.publication-preview-more a {
  font-weight: 600;
}
</style>
