...
### <span data-lang="en">📸 Event Highlights</span><span data-lang="zh" hidden>📸 活动掠影</span>

The bilingual gallery is sourced from `_pages/includes/event-gallery.md` and rendered on the dedicated `/events/` page via `_pages/events.md`.

<div class="event-gallery">
  <figure class="event-gallery__item">
    <img src="/images/events/2024-innovation-day.svg" alt="Wentao Wu presenting at Innovation Day 2024" loading="lazy">
    <figcaption>
  ...
  <figure class="event-gallery__item">
    <img src="/images/events/2023-robotics-workshop.svg" alt="Team discussion during the 2023 robotics workshop" loading="lazy">
    <figcaption>
      <span data-lang="en">2023 Robotics Workshop &mdash; Sharing advances in distributed control.</span>
      <span data-lang="zh" hidden>2023 机器人研讨会——聚焦分布式控制最新进展。</span>
    </figcaption>
  </figure>
  <figure class="event-gallery__item">
    <img src="/images/events/2024-team-outing.svg" alt="Group photo from the 2024 team outing" loading="lazy">
    <figcaption>
      <span data-lang="en">Team Outing 2024 &mdash; Recharging together on the Sai Kung Coastal Trail.</span>
      <span data-lang="zh" hidden>2024 团队团建——一起畅游西贡海岸线。</span>
    </figcaption>
  </figure>
</div>
